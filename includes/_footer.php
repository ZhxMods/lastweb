 ...
 * Clean blue/white footer with links
 * ============================================
 */
...
?>
        ...
        <div class="container">
            <div class="footer-content">
                ...
                <div class="footer-section">
                    <h4 class="footer-title">InfinityFree</h4>
                    <p class="footer-text"><?= __('hero_subtitle') ?></p>
                ...
                <!-- Support -->
                <div class="footer-section">
                    <h4 class="footer-title"><?= __('help_support') ?></h4>
                    <ul class="footer-links">
                        <li><a href="<?= url('/help') ?>"><?= __('help_support') ?></a></li>
                        <li><a href="<?= url('/documentation') ?>"><?= __('documentation') ?></a></li>
                        <?php if (!isLoggedIn()): ?>
            ...
            <div class="footer-bottom">
                <div class="footer-bottom-content">
                    <p class="copyright">
                        &copy; <?= date('Y') ?> InfinityFree. <?= __('all_rights_reserved') ?>
                    </p>
    ...
    <!-- Additional JS can be added by pages -->
